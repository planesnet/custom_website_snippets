...
const dynamicSnippetProductsOptions = s_dynamic_snippet_carousel_options.extend({
     ...
     */
     _renderProductDatasSelector: async function (uiFragment) {
        ...
        const productDataSelectorEl = uiFragment.querySelector('[data-name="product_id_opt"]');
...
options.registry.dynamic_snippet_table_product= dynamicSnippetProductsOptions;
